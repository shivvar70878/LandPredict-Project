...
const API_BASE_AUTO = "http://127.0.0.1:8000";
        ...
        <div id="tab-overview" class="tab-pane active">
          ...
          <div class="terminal-card" id="automationTerminalLogs">
            ...
            <div id="terminalLinesContainer">
              ...
              <div class="terminal-line"><span class="log-time">[${new Date().toLocaleTimeString()}]</span> <span class="log-tag tag-success">MYSQL_PERSIST</span> Persisted real-time corridor metrics and spatial conflict records into MySQL.</div>
            </div>
          </div>
        </div>
